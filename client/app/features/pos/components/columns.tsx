...
export const columns = ({
                        ...
                        }: ColumnsConfig): ColumnDef<Product>[] => [
    {
        accessorKey: 'name',
        header: ({ column }) => (
            <SortableHeader label="الاسم" column={column} />
        ),
    },
    {
    ...
    },
    {
        accessorKey: 'stock',
        header: ({ column }) => (
            <SortableHeader label="المخزون" column={column} align="center" />
        ),
    ...
    },
    {
        accessorKey: 'price',
        header: ({ column }) => (
            <SortableHeader label="السعر" column={column} align="right" />
        ),
        cell: ({ row }) => (
            <div className="text-right font-medium">
                {formatSAR(parseFloat(row.getValue('price')))}
            </div>
        ),
    },
    {
